...
- ❌ Event-frequency residual venue z-score `|z| < 2` for sample-adequate regular-season training attempts (live DB scorecard `max |z| = 3.572`). Frequency diagnostics also report blocked-shot and all-attempt event groups as non-blocking diagnostics.
